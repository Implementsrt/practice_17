...
(
    ...
    `gmt_update`    timestamp                    DEFAULT NULL,
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='spu表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='spu规格表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='sku表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='增值保障';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='sku增值保障';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='sku规格值';